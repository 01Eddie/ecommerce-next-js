            ...
            <div className="px-4 py-6 sm:px-8 sm:py-10">
              <div className="flow-root">
                {cartItems && cartItems.length ? (
                  ...
                  <h1 className="font-bold text-lg">¡Tu carrito esta vacío!</h1>
                )}
              </div>
              <div className="mt-6 border-t border-b py-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <p className="text-lg text-black font-semibold">S/. 0</p>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="mt-5 text-center">
                  ...
                  onClick={()=>router.push('/checkout')}
                    ...
                    className="disabled:opacity-50 group inline-flex w-full items-center justify-center bg-red-500 px-6 py-4 text-lg text-white font-medium uppercase tracking-wide"
                  >
                    Verificar
                  </button>
                </div>
